"""src/apps/users/repositories/saved_searches.py."""
...
from src.apps.users.models import SavedSearch
from src.apps.users.schemas.saved_searches import SavedSearchCreate

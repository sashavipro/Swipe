"""src/apps/announcements/services/announcement.py."""
...
from src.apps.announcements.models import Announcement, Image
...
from src.core.utils import extract_public_id_for_image

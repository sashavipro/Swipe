"""src/apps/announcements/repositories/chessboard.py."""
...
from src.apps.announcements.models import ChessboardRequest, Announcement
from src.apps.announcements.schemas.chessboard import ChessboardRequestCreate
from src.apps.buildings.models import House, Apartment

...
Revision ID: 812076939524
Revises:
Create Date: 2026-01-06 19:10:23.300032
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["owner_id"], ["users.id"], name=op.f("houses_owner_id_fkey")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["house_id"], ["houses.id"], name=op.f("documents_house_id_fkey")
        ),
    ...
    op.create_table(
        ...
        sa.Column("legal_terms", sa.String(), nullable=True),
        sa.ForeignKeyConstraint(
            ["id"], ["houses.id"], name=op.f("house_infos_id_fkey")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("house_infos_pkey")),
    )
    op.create_table(
        "news",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["house_id"], ["houses.id"], name=op.f("news_house_id_fkey")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("announcements_user_id_fkey"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["announcement_id"],
            ["announcements.id"],
            name=op.f("favorites_announcement_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("favorites_user_id_fkey")
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "announcement_id", name=op.f("favorites_pkey")
        ),
    )
    op.create_table(
        "images",
